...
-   Redesign Profile Page
    ...
    -   École
    -   Numéro de Groupe
    -   Niveau d'études (secondaire, collégial, universitaire)
    -   # Profil Publique
    -   Nombre de posts
    -   Posts les plus populaires
    -   Tags préférés
    -   Projets Académiques Partagés
    -   Point d'xp
    -   Badges
    -   # Préférences
    -   Light/Dark Mode
...
- [x] Les tags ne fonctionnent pas
- [x] Remettre le bouton d'ajout a l'agenda dans les examens à venir sur la page Session
- [x] Mettre un design qui montre que c'est une note de professeur sur la page Session
- [ ] 
- [ ] 
- [ ] 
- [ ] 
